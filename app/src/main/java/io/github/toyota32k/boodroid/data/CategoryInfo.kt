...
data class CategoryInfo(val label:String, val color:Color,val sort:Int, val svgPath:String) {
    companion object {
        ...
        fun fromJson(j:JSONObject): CategoryInfo? {
            ...
            val color = if(colorStr!=null) Color.valueOf(Color.parseColor(colorStr)) else Color.valueOf(Color.BLACK)
        ...
        suspend fun getCategoryList(capability: Capability): CategoryList {
            ...
            return withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    val list = jsonList.toIterable().map { j -> CategoryInfo.fromJson(j as JSONObject) }.filterNotNull()
